...
public class SwaggerConfig extends WebMvcConfigurerAdapter {
	...
	public Docket swaggerPlugin() {
		return new Docket(DocumentationType.SWAGGER_2).select().paths(PathSelectors.any())
				.apis(Predicates
						.or(RequestHandlerSelectors.basePackage("com.example.restaurant.restaurantsales.controller")))
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("Api Restaurant Prices")
				.description("This is an api wich allows to insert sales and its productos into RabbitMq queue")
				.license("Apache License Version 2.0").version("0.0.1").build();
	}
